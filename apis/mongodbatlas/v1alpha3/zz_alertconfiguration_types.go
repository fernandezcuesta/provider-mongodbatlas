...
type AlertConfigurationInitParameters struct {
...
type AlertConfigurationObservation struct {
...
type AlertConfigurationParameters struct {
...
// AlertConfigurationSpec defines the desired state of AlertConfiguration
type AlertConfigurationSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     AlertConfigurationParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider AlertConfigurationInitParameters `json:"initProvider,omitempty"`
}

// AlertConfigurationStatus defines the observed state of AlertConfiguration.
type AlertConfigurationStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        AlertConfigurationObservation `json:"atProvider,omitempty"`
}
...
// AlertConfiguration is the Schema for the AlertConfigurations API.
...
type AlertConfiguration struct {
	...
	Spec   AlertConfigurationSpec   `json:"spec"`
	Status AlertConfigurationStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// AlertConfigurationList contains a list of AlertConfigurations
type AlertConfigurationList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []AlertConfiguration `json:"items"`
}

// Repository type metadata.
var (
	AlertConfiguration_Kind             = "AlertConfiguration"
	AlertConfiguration_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: AlertConfiguration_Kind}.String()
	AlertConfiguration_KindAPIVersion   = AlertConfiguration_Kind + "." + CRDGroupVersion.String()
	AlertConfiguration_GroupVersionKind = CRDGroupVersion.WithKind(AlertConfiguration_Kind)
)

func init() {
	SchemeBuilder.Register(&AlertConfiguration{}, &AlertConfigurationList{})
}
