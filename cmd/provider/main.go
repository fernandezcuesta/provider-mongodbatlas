...
func main() {
	var (
		app                     = kingpin.New(filepath.Base(os.Args[0]), "Terraform based Crossplane provider for ProviderMongoDBAtlas").DefaultEnvars()
	...
	if *enableExternalSecretStores {
		...
		o.ESSOptions = &ujcontroller.ESSOptions{}
		if *essTLSCertsPath != "" {
